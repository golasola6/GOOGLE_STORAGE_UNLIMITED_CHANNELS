...
async def start_command(client: Client, message: Message):
    ...
    if len(text) > 7:
        ...
        temp.ASSIGNED_CHANNEL[user_id] = list(channel_id) 

        temp.FILE_ID[id] = {"LAZY_FILE": base64_string}
        
        buttons = []
        for ch in temp.ASSIGNED_CHANNEL[user_id]:
